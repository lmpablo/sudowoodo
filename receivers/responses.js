module.exports = {
    salutations: {
        neutral: ['Hey!', 'Hi!', 'Hello there!', 'Oh hey!', 'Hiya!', 'Why, hello!',
            ...
            'Waaaaaazzup', 'Wazzup', 'What\'s up', 'Whattup', 'Yo', 'Oi.', 'Beep Boop :robot_face:'],
        withName: ['Hey $USER$!', 'Hi, $USER$!', 'Oh hey $USER$!', 'Bonjour $USER$!', 'Howdy, $USER$!',
            '$USER$, greetings.', 'Guten Tag $USER$', 'Whattup $USER$'],
        annoyed: ['And you are?', 'Why are you talking to me $USER$?',
            'Who gave you permission to -- ugh, nevermind.', 'What is it now?',
            'OMG WHAT??', '...$USER$. What?', '...What?']
    },
    agree: {
    ...
    acknowledgement: {
        ...
        neutral: ['Copy.', 'Copy that.', 'Loud and clear, $USER$', 'Affirmative.', 'I gotcha', 'Beep Boop :robot_face:'],
        weak: ['ok.', 'kk.', 'yeah k.', 'mhm', 'yeah, yeah.']
    },
    hesitation: ['Maybe.', 'Probably.', 'Probably?', 'Perhaps...', 'I guess so?', 'I guess that\'s possible'],
    congratulations: {
        strong: ['NICE!', 'NICE, $USER$!', 'WOOHOO!', 'SWEET!', 'OH MAN, $USER$!',
            'VERY. NICE.', 'VERY NICE!', 'GOOD JOB!', 'ALRIGHT, $USER$!', 'ALRIGHT!',
            'GODDAMN.', '$USER$. BRO.'],
    ...
    replyTo: {
        thanks: ['No problem!', 'Anytime!', 'Anything for you, $USER$.',
            'No no no. Thank YOU.', 'Not a problem!', 'Sure thing!', 'I gotchu, $USER$ :fist:'],
        who: ["I'm but a bot.", "I know you are, but what am I",
